...
var goJong2 = new King('1852-9-8', '이형', '고종');
console.log(goJong2);
...
/*
    ...
    - [] 표기법은 모든 이름에서 사용 가능, 접근 하려고하는 속성을 동적으로 지정 가능
    - 객체에 존재하지 않는 속성에 접근하려 하면 undefined 반환
*/
console.log(jhj.age);
console.log(jhj['age']);
console.log(jhj[age]);
console.log(jhj['first name']);

var property = 'age';
console.log(jhj[property]);
