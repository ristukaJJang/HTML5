...
/*
    ...
    - 배열[인덱스]로 요소에 접근 가능, 존재하지 않는 인덱스에 접근하면 undefinded 반환 
    - 각 요소의 데이터 타입이 서로 달라도 됨
*/
var empthArray = [];
console.log(empthArray, typeof empthArray, empthArray[0]);
...
/*
    ...
    - 뛰어넘은 인덱스 값에는 empty 요소가 추가
*/
empthArray[1] = 10;
console.log(empthArray, empthArray[0]);
...
/*
    - for-in 방식은 index를 사용하여 한 번 더 접근을 해야하기 때문에 단순히 값을 복사하고 읽는데에는 부적합함 
    - for-of 방식을 사용하여 배열의 요소를 복사해서 직접 사용할 수 있음
*/
// for(var itme of fruits) {
//     console.log(item);
// }
...
/*
    indexOf(element) : 
    - 배열의 매개변수로 전달된 요소가 존재하면 첫번째 인덱스 반환
    - 존재하지 않으면 -1 반환
*/
...
/*
    includes(element) :
    - 배열에 전달된 매개변수가 요소에 존재하면 true, 존재하지 않다면 false
*/
...
/*
    push(element) :
    - 배열의 마지막 인덱스에 요소를 추가하고 변경된 길이 반환
*/
...
/*
    ...
    - 배열의 요소를 제거하고 제거한 위치에 요소를 갈아끼운 배열 반환
*/
